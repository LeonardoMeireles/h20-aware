...
class Doodler {
    ...
    // doodler leaves the canvas to the left
...
// to display the finish menu we saw previously
function showFinishMenu() {
    document.getElementById('finish-game-menu').style.display = 'block';
    document.getElementById('finish-game-score').innerHTML = score;

}

function hideFinishMenu() {
    document.getElementById('finish-game-menu').style.display = 'none';
}
